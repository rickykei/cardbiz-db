...
exports.create = async (req, res) => {
	...
	const staff = new Staff({
		...
		work_email_label: req.body.work_email_label,
		work_email2_label: req.body.work_email2_label,
		work_email3_label: req.body.work_email3_label,
		...
		work_tel_label: req.body.work_tel_label,
		work_tel2_label: req.body.work_tel2_label,
		work_tel3_label: req.body.work_tel3_label,
		work_tel4_label: req.body.work_tel4_label,
		mobile: req.body.mobile,
		mobile2: req.body.mobile2,
		mobile3: req.body.mobile3,
		mobile4: req.body.mobile4,
		mobile_label: req.body.mobile_label,
		mobile2_label: req.body.mobile2_label,
		mobile3_label: req.body.mobile3_label,
		mobile4_label: req.body.mobile4_label,
		home_tel: req.body.home_tel,
		fax: req.body.fax,
		home_tel_label: req.body.home_tel,
		fax_label: req.body.fax_label,
		...
		address2_label: req.body.address2_label,
		address3_label: req.body.address3_label,
		address4_label: req.body.address4_label,
		...
		facebook_messenger_url: req.body.facebook_messenger_url,
