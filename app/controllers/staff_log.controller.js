		...
		.then((objs) => {
			...
			objs.forEach((obj) => {
				...
				staffs.push({
					...
					work_email_label: obj.work_email_label,
					work_email2_label: obj.work_email2_label,
					work_email3_label: obj.work_email3_label,
					...
					work_tel_label: obj.work_tel_label,
					work_tel2_label: obj.work_tel2_label,
					work_tel3_label: obj.work_tel3_label,
					work_tel4_label: obj.work_tel4_label,

					mobile: obj.mobile,
					mobile2: obj.mobile2,
					mobile3: obj.mobile3,
					mobile4: obj.mobile4,
					mobile_label: obj.mobile_label,
					mobile2_label: obj.mobile2_label,
					mobile3_label: obj.mobile3_label,
					mobile4_label: obj.mobile4_label,

					home_tel: obj.home_tel,
					fax: obj.fax,
					home_tel_label: obj.home_tel_label,
					fax_label: obj.fax_label,
			...
			worksheet.columns = [
				...
				{ header: "work_email_label", key: "work_email_label", width: 25 },
				{ header: "work_email", key: "work_email", width: 25 },
				{ header: "work_email2_label", key: "work_email2_label", width: 25 },
				{ header: "work_email2", key: "work_email2", width: 25 },
				{ header: "work_email3_label", key: "work_email3_label", width: 25 },
				{ header: "work_email3", key: "work_email3", width: 25 },
				{ header: "home_email_label", key: "home_email_label", width: 25 },
				...
				{ header: "work_tel3_label", key: "work_tel3_label", width: 25 },
				{ header: "work_tel3", key: "work_tel3", width: 25 },
				{ header: "work_tel4_label", key: "work_tel4_label", width: 25 },
				{ header: "work_tel4", key: "work_tel4", width: 25 },
				{ header: "mobile_label", key: "mobile_label", width: 25 },
				{ header: "mobile", key: "mobile", width: 25 },
				{ header: "mobile2_label", key: "mobile2_label", width: 25 },
				{ header: "mobile2", key: "mobile2", width: 25 },
				{ header: "mobile3_label", key: "mobile3_label", width: 25 },
				{ header: "mobile3", key: "mobile3", width: 25 },
				{ header: "mobile4_label", key: "mobile4_label", width: 25 },
				{ header: "mobile4", key: "mobile4", width: 25 },
				{ header: "home_tel_label", key: "home_tel_label", width: 25 },
				{ header: "home_tel", key: "home_tel", width: 25 },
				{ header: "fax_label", key: "fax_label", width: 25 },
				...
				{ header: "address_label", key: "address_label", width: 25 },
				{ header: "address", key: "address", width: 25 },
				{ header: "address2_label", key: "address2_label", width: 25 },
				{ header: "address2", key: "address2", width: 25 },
				{ header: "address3_label", key: "address3_label", width: 25 },
				{ header: "address3", key: "address3", width: 25 },
				{ header: "address4_label", key: "address4_label", width: 25 },
